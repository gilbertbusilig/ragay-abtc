  ...
  useEffect(() => {
    Promise.all([
      ...
      if (patRes.status === 'ok' && patRes.data?.patient) {
        ...
        if (inc) {
          setForm({
            bite_datetime: inc.bite_datetime || '',
            place_of_exposure: inc.place_of_exposure || '',
            animal_type: inc.animal_type || 'dog',
            animal_other: inc.animal_other || '',
            ownership: inc.ownership || '',
            pet_vaccine_date: inc.pet_vaccine_date || '',
            circumstance: inc.circumstance || '',
    ...
    <div>
      <div className="page-header">
        <div>
          ...
          <h1 className="page-title">Edit Bite Incident</h1>
          <p className="page-subtitle">Editing incident details for this patient</p>
        </div>
      </div>
