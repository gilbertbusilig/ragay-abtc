      ...
      <div className="page">
        <div className="page-content">
          <div style={{ display:'flex', alignItems:'center', justifyContent:'center', gap:10, marginBottom:5, paddingBottom:5, borderBottom:'2px solid #1d4ed8' }}>
            <img src="/logos/lgu_logo.jpg"         alt="" style={{ width:46, height:46, objectFit:'contain', borderRadius:8, boxShadow:'0 3px 8px rgba(0,0,0,.25)', mixBlendMode:'multiply' }} />
            ...
            <img src="/logos/bagong_pilipinas.jpg" alt="" style={{ width:46, height:46, objectFit:'contain', borderRadius:8, boxShadow:'0 3px 8px rgba(0,0,0,.25)', mixBlendMode:'multiply' }} />
          </div>
